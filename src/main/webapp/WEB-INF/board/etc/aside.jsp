...
<body>
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="${root}/main">
        <img src="${root}/img/board/logo2.png" class="navbar-brand-img h-100" alt="...">
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <c:if test="${select==1}">
    	<a class="nav-link active" href="${root}/main">
    	  </c:if>
    	  <c:if test="${select!=1}">
        ...
        <li class="nav-item">
    	     <c:choose>
    	     	<c:when test="${mn.boardid eq 0}">
					<c:if test="${select==10}">
            		<a class="nav-link active" href="${root}/board/list?boardid=${mn.boardid}&boardname=${mn.boardName}">
            		</c:if>
            		<c:if test="${select!=10}">
            		<a class="nav-link" href="${root}/board/list?boardid=${mn.boardid}&boardname=${mn.boardName}">
            		</c:if>
            	</c:when>
        ...
        <li class="nav-item">
           <c:if test="${select==6}">
          <a class="nav-link active" href="${root}/billing">
             </c:if>
           <c:if test="${select!=6}">
          <a class="nav-link" href="${root}/billing">
             </c:if>
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
         <c:if test="${select==8}">
          <a class="nav-link active" href="${root}/user/usertables">
        </c:if>
           <c:if test="${select!=8}">
          <a class="nav-link" href="${root}/user/usertables">
        </c:if>
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>유저관리게시판</title>
            ...
            <span class="nav-link-text ms-1">유저관리게시판</span>            
          </a>
        </li>
